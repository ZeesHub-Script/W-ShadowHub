...
Info=Window:AddTab({ Title="Tab Status And Info" }),
    Main=Window:AddTab({ Title="Tab Farming" }),

Main1=Window:AddTab({ Title="Tab Farming (More)" }),
    Sea=Window:AddTab({ Title="Tab Sea Event" }),
    Item=Window:AddTab({ Title="Tab Get Items" }),
    Setting=Window:AddTab({ Title="Tab Settings" }),
    Status=Window:AddTab({ Title="Tab Server" }),
    Stats=Window:AddTab({ Title="Tab Upgrade Points" }),
    Player=Window:AddTab({ Title="Tab LocalPlayer" }),
    Teleport=Window:AddTab({ Title="Tab Teleport/Travel" }),
    Visual=Window:AddTab({ Title="Tab Visual" }),
    Fruit=Window:AddTab({ Title="Tab Fruit/ESP" }),
    Raid=Window:AddTab({ Title="Tab Dungeon" }),
    Race=Window:AddTab({ Title="Tab Race" }),
    Shop=Window:AddTab({ Title="Tab Shop" }),
    Misc=Window:AddTab({ Title="Tab More" }),
}
